...
var zhMessages = map[string]string{
	...
	"foundKey":                "发现 %v 个现有公钥。请选择实际控制电脑使用的那一把。",
	...
	"alreadyRunning":          "另一个 SSH Launchpad 修改流程正在运行。请回到那个窗口，避免同时修改。",
	"yes":                     "是",
	"no":                      "否",
	...
	"scheduleHelp":            "持锁、可取消地延迟高风险操作（请保持此进程运行）",
	"journalHelp":             "恢复记录目录",
...
var enMessages = map[string]string{
	...
	"foundKey":                "Found %v public keys. Choose the one used by the actual controller computer.",
	...
	"alreadyRunning":          "Another SSH Launchpad mutation is running. Return to that window to avoid concurrent changes.",
	"yes":                     "yes",
	"no":                      "no",
	...
	"scheduleHelp":            "delay risky work while retaining the lock (keep this process running)",
