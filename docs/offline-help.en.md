...
v0.2.4 is not code-signed. When the operating system warns, verify the Release SHA-256 first; disabling SmartScreen or security software is not recommended.
